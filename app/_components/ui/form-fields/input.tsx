...
import { FieldError, FieldClearBtn } from "@/_components/ui/form-fields";
import { FieldHelperText } from "@/_components/ui/form-fields/field-helper-text";
...
const inputClasses = {
  base: "block peer w-full bg-transparent font-normal focus:outline-none transition duration-200 disabled:bg-gray-100 disabled:placeholder:text-gray-400 disabled:cursor-not-allowed disabled:border-gray-200",
  error:
...
const inputClassesWithIcon = {
  ...
  startPadding: {
    base: "rtl:pl-[inherit] ",
    size: {
      sm: "pl-16 rtl:pr-10",  // was pl-8
      DEFAULT: "pl-14 rtl:pr-12",  // was pl-10
      lg: "pl-20 rtl:pr-14",  // was pl-12
      xl: "pl-16 rtl:pr-16",  // was pl-14
    },
  },
  endPadding: {
    base: "rtl:pr-[inherit]",
        ...
        <label className="block text-base font-bold leading-7">
          ...
          >
            {startIcon && (
              <div
                className={clsx(
                  "absolute left-5 max-md:left-2 top-0 flex h-full items-center justify-center bg-transparent p-1 leading-normal rtl:left-auto rtl:right-0 outline-none focus:outline-none focus-visible:outline-none",
                  startIconClickable
                    ? "z-[2] cursor-pointer"
                    : "pointer-events-none",
