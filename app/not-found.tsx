            ...
            <div className="relative -mt-[272px] max-md:-mt-12 bg-[FAFAFA] backdrop-blur-lg p-8 pt-0 h-[360px] max-md:h-auto border border-black/20 rounded-40 w-full flex-col flex items-center max-md:p-4 max-md:rounded-[20px]">
              ...
              <div className="relative flex flex-col z-10 items-center justify-center h-full gap-4">
                ...
                <div 
                  ...
                  className="flex h-16 max-md:h-12 rounded-full border border-black/20 text-xl max-md:text-sm p-2 max-md:pl-1 text-white gap-3 items-center pr-6 cursor-pointer bg-black hover:bg-gray-800 transition-colors"
                >
                  <span className="h-12 w-12 max-md:h-10 max-md:w-10 bg-white rounded-full items-center justify-center flex">
                    <img src="/images/vectors/backArrow.svg" />
                  </span>
                  Return to home
                </div>
              </div>
