...
import { StudDetailsForm, studDetailsSchema } from "./_steps/stud-details-form";
import FinalPayment from "./_steps/final-payment";

const formSteps = [
  {
    title: "Stud or Bitch Listing",
    description: "Create a new stud or bitch listing",
    form: <StudDetailsForm />,
    validationSchema: studDetailsSchema,
  },
  {
...
const StudListingFormWrapper = () => {
  const isClient = useIsClient();

  if (!isClient) return null;

  const formData = localStorage.getItem(
    localStorageKeys.STUD_LISTING_FORM_DATA
  );
...
export { StudListingFormWrapper as StudListingForm };
