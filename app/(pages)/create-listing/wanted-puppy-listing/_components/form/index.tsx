...
import {
  WantedPuppyDetailsForm,
  wantedPuppyDetailsSchema,
} from "./_steps/wanted-puppy-details-form";
import FinalPayment from "./_steps/final-payment";

const formSteps = [
  {
    title: "Wanted puppy Listing",
    description: "Create a new Wanted Puppy listing",
    form: <WantedPuppyDetailsForm />,
    validationSchema: wantedPuppyDetailsSchema,
  },
  {
...
const WantedPuppyListingFormWrapper = () => {
  const isClient = useIsClient();

  if (!isClient) return null;

  const formData = localStorage.getItem(
    localStorageKeys.WANTED_PUPPY_LISTING_FORM_DATA
  );
  ...
  return (
    ...
    >
      <WantedPuppyListingForm />
    </MultiStepFormProvider>
  );
};

export { WantedPuppyListingFormWrapper as WantedPuppyListingForm };
